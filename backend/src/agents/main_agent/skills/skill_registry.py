    ...
    def load_records(self, records: List[Any]) -> int:
        ...
        for rec in records:
            ...
            self._skills[name] = {
                ...
                "tools": [],
                # Reference-file manifest — served on demand.
