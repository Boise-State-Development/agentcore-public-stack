...
async def list_users(
    ...
    """
    logger.info(f"Admin {admin_user.name} listing users (status={status}, domain={domain})")
...
async def search_users(
    ...
    """
    logger.info(f"Admin {admin_user.name} searching for user by email: {email}")
...
async def list_email_domains(
    ...
    """
    logger.info(f"Admin {admin_user.name} listing email domains")
...
async def get_user_detail(
    ...
    """
    logger.info(f"Admin {admin_user.name} requesting user detail: {user_id}")
