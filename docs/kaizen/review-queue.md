...
### [2026-08-28] Correct the cache-write premium and fix the Global/Regional rate tier
...
### [2026-08-28] Take Strands 1.51 → 1.54 as an instrumented cache experiment, not a routine bump
...
### [2026-08-28] Make `supported_params` omission mean *unsupported*, and audit model lifecycle
...
### [2026-08-28] Retire the tool-mutation premise and strike two resolved MCP blockers
